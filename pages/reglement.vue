<template>
    <div>
        <div v-for="(reglement, index) in allReglements" :key="index" class="bg-blue-100 shadow-lg">
            <div class="container mx-auto">
                ...
                <div v-if="reglement.contentmatrix[0].afbeeldingnaasttekst" class="flex items-center mx-auto w-10/12 py-32">
        ...
        <div v-for="(reglement, index) in allReglements" :key="index" class="container mx-auto">
