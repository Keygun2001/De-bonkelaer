<template>
  <div>
    <div v-for="(home, index) in allHomepaginas" :key="index" class="bg-blue-100 shadow-lg">
      <div class="container mx-auto">
        <div class="flex md:flex-row flex-col items-center mx-auto w-10/12 py-32">
          ...
          <div class="flex sm:flex-col md:flex-row w-6/12">
            <img class="w-10/12" :src="home.contentmatrix[0].afbeeldingnaasttekst.url">
          </div>
        </div>
      </div>
    </div> 

    <div v-for="(home, index) in allHomepaginas" :key="index" class="container mx-auto">
      <div class="flex items-center mx-auto w-10/12 py-32">
    ...
    <div v-for="(home, index) in allHomepaginas" :key="index" class="bg-blue-100 shadow-top">
      <div class="container mx-auto"> 
        <div class="flex items-center mx-auto w-10/12 py-32">
          <div class="flex justify-center items-center w-full">
            <div class="w-1/12" @click="prev">
